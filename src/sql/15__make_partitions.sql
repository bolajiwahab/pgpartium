        ...
        SELECT string_agg(
                   format(
                     ...
                     , format(                                                     --<1: index_create_statement>
                         ...
                         , v_partition_schema                                      --<4: table_schema>
                         , v_partition.partition_name                              --<5: table_name>
                         , partition_indexes.index_definition_without_predicate    --<6: index_definition_without_predicate>
                       )
