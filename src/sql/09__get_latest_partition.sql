CREATE OR REPLACE FUNCTION pgpartix.get_latest_partition (
    p_table_schema text
  , p_table_name text
)
RETURNS TABLE (
...
/*
    ...
    * @return partition_schema (text): The schema of the latest partition.
    * @return partition_name (text): The name of the latest partition.
    * @return lower_bound (timestamptz): The lower bound of the latest partition.
    * @return upper_bound (timestamptz): The upper bound of the latest partition.
*/
